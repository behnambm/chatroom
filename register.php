...
<body>
     <div class="container register-page">  
        <div class="row"> 
            <div class="wrapper reg-wrapper col-xs-push-1 col-xs-10 col-sm-push-3 col-sm-6 col-md-push-4 col-md-4 col-lg-3">
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true"><!-- picture select section -->
